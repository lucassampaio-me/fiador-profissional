---
description: Regras de desenvolvimento que definem comportamento obrigatório para execução apenas do que foi solicitado, sem sugestões ou melhorias não pedidas
globs: 
alwaysApply: true
---
